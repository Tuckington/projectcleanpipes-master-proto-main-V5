...
def writeCollatedResults(ISP_List,allResponseCodes):
    ...
    for isp in ISP_List:
        ...
        New_ISP_Domain_Results_Interpreter = ISP_Domain_Results_Interpreter(isp.name,isp,ISP_List,domain_response_codes,default_DNS_response_codes,public_DNS_response_codes, List_Of_Domains("our_data\copyright_testing.txt"))
...
def main():
    ...
    #CalculateListOfDomains("our_data\copyright_testing.txt","Results\Test.csv")
