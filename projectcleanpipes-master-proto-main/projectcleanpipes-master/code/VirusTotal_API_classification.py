...
def retrieve_category(url):
    api_key = "YOUR_API_KEY"  # Replace with your Virus Total API key
...
input_file = "our_data\illegal-streaming_sites.txt"

with open(input_file, "r") as file:
    urls = file.read().splitlines()

# Outputs categories in a .csv file
output_file = "our_results\VirusTotal_website_categories.csv"
